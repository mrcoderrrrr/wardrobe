...
class ViewPagerAdapterBottom(var context:Context, private var images: ArrayList<BottomImageModel>):RecyclerView.Adapter<ViewPagerAdapterBottom.ViewPagerViewHolder>() {
